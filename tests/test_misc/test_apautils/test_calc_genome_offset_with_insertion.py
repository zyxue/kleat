...
def test_for_contig_with_three_base_insertion_with_clv_before_the_insertion(ctg_offset, expected_gnm_offset):
    """
    TT         <-bridge read tail
     └CG       <-bridge read
...
def test_for_contig_with_three_base_insertion_with_clv_inside_the_insertion(ctg_offset, expected_gnm_offset):
    """
        TT         <-bridge read tail
         └AG       <-bridge read
          ||       # blank line to separate the bridge read the insertion
...
def test_for_contig_with_three_base_insertion_with_clv_after_the_insertion(ctg_offset, expected_gnm_offset):
    """
       TT      <-bridge read tail
        └GT    <-bridge read
         |     # blank line to separate the bridge read the insertion
...
def test_for_contig_with_one_base_insertion_with_clv_before_insertion(ctg_offset, expected_gnm_offset):
    """
    TT
     └CG       <-bridge read
      |        # blank line to separate the bridge read the insertion
...
def test_for_contig_with_one_base_insertion_with_clv_inside_insertion(ctg_offset, expected_gnm_offset):
    """
      TT
       └GC     <-bridge read
        |      # blank line to separate the bridge read the insertion
...
def test_for_contig_with_one_base_insertion_with_clv_after_insertion(ctg_offset, expected_gnm_offset):
    """
       TT
        └AC    <-bridge read
         |     # blank line to separate the bridge read the insertion
